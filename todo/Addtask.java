...
public class Addtask extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      if(!(title.getText().equals("")|| date.getText().equals("")||status.getText().equals("")||jTextArea1.getText().equals(""))){
        try {
            // TODO add your handling code here:o
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/todo", "root","");
            PreparedStatement pt=con.prepareStatement("insert into task (title,duedate,status,description) values(?,?,?,?)");
            pt.setString(1, title.getText());
            pt.setString(2, date.getText());
            pt.setString(3, status.getText());
